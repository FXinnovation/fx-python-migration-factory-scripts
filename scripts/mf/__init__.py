...
ENV_VAR_MIGRATION_FACTORY_WINDOWS_USERNAME = ['MF_WINDOWS_USERNAME', 'MF_FACTORY_WINDOWS_USERNAME', 'MF_MIGRATION_FACTORY_WINDOWS_USERNAME']
ENV_VAR_MIGRATION_FACTORY_WINDOWS_PASSWORD = ['MF_WINDOWS_PASSWORD', 'MF_FACTORY_WINDOWS_PASSWORD', 'MF_MIGRATION_FACTORY_WINDOWS_PASSWORD']
