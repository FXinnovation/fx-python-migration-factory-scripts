...
ENV_VAR_CONFIG_FILE = ['MF_CONFIG_FILE']
...
ENV_VAR_WINDOWS_USERNAME = ['MF_WINDOWS_USERNAME', 'MF_FACTORY_WINDOWS_USERNAME', 'MF_MIGRATION_FACTORY_WINDOWS_USERNAME']
ENV_VAR_WINDOWS_PASSWORD = ['MF_WINDOWS_PASSWORD', 'MF_FACTORY_WINDOWS_PASSWORD', 'MF_MIGRATION_FACTORY_WINDOWS_PASSWORD']

ENV_VAR_LINUX_USERNAME = ['MF_LINUX_USERNAME', 'MF_FACTORY_LINUX_USERNAME', 'MF_MIGRATION_FACTORY_LINUX_USERNAME']
ENV_VAR_LINUX_PASSWORD = ['MF_LINUX_PASSWORD', 'MF_FACTORY_LINUX_PASSWORD', 'MF_MIGRATION_FACTORY_LINUX_PASSWORD']
ENV_VAR_LINUX_PRIVATE_KEY_FILE = ['MF_LINUX_PRIVATE_KEY_FILE', 'MF_FACTORY_LINUX_PRIVATE_KEY_FILE', 'MF_MIGRATION_FACTORY_LINUX_PRIVATE_KEY_FILE']
